...
export default function Header() {
  ...
  const services = [
    { name: 'Cloud Services', path: '/cloud-consulting' },
    { name: 'Cybersecurity Services', path: '/cybersecurity' },
    { name: 'Business Applications', path: '/business-applications' },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <button onClick={navigateToHome} className="flex items-center space-x-2">
            <img src="/skyshift-logo-header.png" alt="SkyShift Logo" className="w-10 h-10" />
